...
def create_site(folder_to_scan, page_color="#bb6e6e", toc_color="#007bff", toc_bg_color="rgba(255, 255, 255, 0.9)", output_file="gallery.html"):
    """
            ...
            for basename, files in files_by_basename.items():
                ...
                for file_info in files:
                    if file_info['extension'] in image_extensions:
                        if image_file is None or image_extensions.index(file_info['extension']) < image_extensions.index(image_file['extension']):
                            if image_file:
...
<body>'''
    ...
    try:
        ...
        # Write to file
        output_path = Path(folder_to_scan) / output_file
...
def example_usage():
    """Example of how to use the create_site function"""
    
    # Basic usage
    create_site("C:/Users/Ashut/OneDrive/Desktop/New folder/gallery")
    
    # With custom colors including TOC background
    create_site("C:/Users/Ashut/OneDrive/Desktop/New folder/gallery", 
                page_color="#2c3e50", 
                toc_color="#e74c3c",
                toc_bg_color="rgba(52, 73, 94, 0.8)")
    
    # With custom output file name and all colors
    create_site("C:/Users/Ashut/OneDrive/Desktop/New folder/gallery", 
                page_color="#8b4513", 
                toc_color="#f39c12",
                toc_bg_color="#34495e",
                output_file="my_charts.html")
